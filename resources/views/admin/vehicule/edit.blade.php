        ...
        <div class="relative flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-indigo-100 text-sm mt-1">Modifiez les informations du véhicule</p>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Modifiez les détails du véhicule #{{ $vehicule->immatriculation }}</p>
                    </div>
                </div>
            </div>

            <!-- Formulaire -->
            <form method="POST" action="{{ route('admin.vehicules.update', $vehicule->id) }}" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="mt-6 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-700">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Statut actuel du véhicule :</p>
                            <p class="text-sm font-semibold">
                                @if($vehicule->statut == 'disponible')
                                    <span class="text-emerald-600 dark:text-emerald-400">🟢 Disponible</span>
                                @elseif($vehicule->statut == 'mission')
                                    <span class="text-sky-600 dark:text-sky-400">🔵 En mission</span>
                                @else
                ...
                <div class="mt-8 flex flex-col sm:flex-row gap-3">
                    <button type="submit"
                            class="group relative overflow-hidden px-6 py-3 bg-indigo-600 hover:bg-indigo-700 rounded-lg shadow-lg transition-all duration-300 hover:scale-105 flex-1">
                    ...
                    <a href="{{ route('admin.vehicules.index') }}"
                       class="px-6 py-3 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-lg transition-all duration-300 hover:scale-105 text-center flex-1">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 animate-fade-in-up" style="animation-delay: 0.2s">
        <div class="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl p-4 border border-indigo-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xs text-indigo-600 uppercase tracking-wider">Information</p>
                    <p class="text-sm text-indigo-900 font-medium">Tous les champs sont obligatoires</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl p-4 border border-emerald-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xs text-emerald-600 uppercase tracking-wider">Conseil</p>
                    <p class="text-sm text-emerald-900 font-medium">L'immatriculation doit être unique</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl p-4 border border-amber-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-amber-900 font-medium">Le statut affecte la disponibilité</p>
                </div>
            </div>
        </div>
    </div>
