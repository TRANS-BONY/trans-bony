...
<title>TRANS BONY - Espace Gestionnaire</title>
        ...
        <div
            ...
            <div class="p-6">
                <div class="flex items-center justify-between mb-8">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-blue-300 dark:text-gray-400 mt-1">Espace Gestionnaire</p>
                        </div>
                    </div>
                ...
                <div class="space-y-2">
                    ...
                    <a href="{{ route('gestionnaire.dashboard') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group" :class="currentPageTitle === 'Tableau de bord' ? 'active' : ''">
                    ...
                    <div class="pt-6 pb-2">
                        <p class="text-[10px] uppercase tracking-[0.2em] text-white/40 font-bold px-1">Gestion Flotte</p>
                    </div>

                    <a href="{{ route('gestionnaire.vehicules.index') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group" :class="currentPageTitle === 'Véhicules' ? 'active' : ''">
                    ...
                    <a href="{{ route('gestionnaire.chauffeurs.index') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group" :class="currentPageTitle === 'Chauffeurs' ? 'active' : ''">
                    ...
                    <a href="{{ route('gestionnaire.maintenances.index') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group" :class="currentPageTitle === 'Maintenances' ? 'active' : ''">
                    ...
                    <a href="{{ route('gestionnaire.documents.index') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group" :class="currentPageTitle === 'Documents' ? 'active' : ''">
                        ...
                        <span class="flex-1 text-sm font-medium">Pièces & Documents</span>
                    </a>

                    <a href="{{ route('gestionnaire.voyages.index') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group" :class="currentPageTitle === 'Voyages' ? 'active' : ''">
                    ...
                    <a href="{{ route('gestionnaire.carburant.index') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group" :class="currentPageTitle === 'Carburant' ? 'active' : ''">
                    ...
                    <div class="pt-8 mt-4 border-t border-white/10">
                        <form method="POST" action="{{ route('logout') }}" id="logout-form-gestion">
                            @csrf
                ...
                <div class="px-4 sm:px-6 py-3 flex justify-between items-center">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5 hidden sm:block">Espace Gestionnaire • {{ auth()->user()->name }}</p>
                        </div>
                    </div>
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" class="flex items-center gap-3 p-1 pr-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-100 dark:border-gray-600 hover:bg-gray-100 transition shadow-sm">
                                ...
                                <div class="hidden md:block text-left">
                                    ...
                                    <p class="text-[10px] text-gray-500 dark:text-gray-400">Gestionnaire</p>
                                </div>
