    ...
    <div
        ...
        <div class="p-6 flex-1">
            ...
            <div class="space-y-1">
                ...
                <!-- Dashboard -->
                <a href="{{ route('agent.dashboard') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group">
                ...
                <!-- Voyages -->
                <a href="{{ route('agent.voyages') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group">
                    <div class="w-8 h-8 flex items-center justify-center rounded-lg bg-white/10 group-hover:bg-blue-500/30 transition-all">
        ...
        <header class="bg-white dark:bg-gray-800 shadow-sm sticky top-0 z-10 border-b border-gray-100 dark:border-gray-700">
            <div class="px-4 sm:px-6 py-3 flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    <button @click="sidebarOpen = !sidebarOpen" class="lg:hidden text-gray-500 dark:text-gray-400 hover:text-blue-600 transition p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl">
