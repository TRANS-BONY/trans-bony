        ...
        <div
            ...
            <div class="p-6">
                <div class="flex items-center justify-between mb-8">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-blue-300 dark:text-gray-400 mt-1">Espace Technique</p>
                        </div>
                    </div>
                ...
                <div class="space-y-2">
                    ...
                    <a href="{{ route('technicien.dashboard') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group" :class="currentPageTitle === 'Tableau de bord' ? 'active' : ''">
                    ...
                    <div class="pt-6 pb-2">
                        <p class="text-[10px] uppercase tracking-[0.2em] text-white/40 font-bold px-1">Maintenance Flotte</p>
                    </div>

                    <a href="{{ route('technicien.maintenances.index') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group" :class="currentPageTitle === 'Maintenances' ? 'active' : ''">
                        ...
                        <span class="flex-1 text-sm font-medium">Gestion Maintenances</span>
                    </a>

                    <a href="{{ route('technicien.vehicules.index') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group" :class="currentPageTitle === 'Véhicules' ? 'active' : ''">
                        ...
                        <span class="flex-1 text-sm font-medium">Liste des Véhicules</span>
                    </a>

                    <!-- Déconnexion -->
                    <div class="pt-8 mt-4 border-t border-white/10">
                        <form method="POST" action="{{ route('logout') }}" id="logout-form-tech">
                            @csrf
                ...
                <div class="px-4 sm:px-6 py-3 flex justify-between items-center">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5 hidden sm:block">Espace Technicien • {{ auth()->user()->name }}</p>
                        </div>
                    </div>
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" class="flex items-center gap-3 p-1 pr-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-100 dark:border-gray-600 hover:bg-gray-100 transition shadow-sm">
                                ...
                                <div class="hidden md:block text-left">
                                    ...
                                    <p class="text-[10px] text-gray-500 dark:text-gray-400">Technicien</p>
                                </div>
