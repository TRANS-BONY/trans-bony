    ...
    <div
        ...
        <div class="p-6 flex-1">
            ...
            <div class="space-y-1">
                ...
                <!-- Dashboard -->
                <a href="{{ route('manager.dashboard') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group">
                ...
                <a href="{{ route('manager.voyages.index') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group">
                    <div class="w-8 h-8 flex items-center justify-center rounded-lg bg-white/10 group-hover:bg-purple-500/30 transition-all">
                ...
                <a href="{{ route('manager.vehicules.index') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group">
                    <div class="w-8 h-8 flex items-center justify-center rounded-lg bg-white/10 group-hover:bg-purple-500/30 transition-all">
                ...
                <a href="{{ route('manager.chauffeurs.index') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group">
                    <div class="w-8 h-8 flex items-center justify-center rounded-lg bg-white/10 group-hover:bg-purple-500/30 transition-all">
                ...
                <a href="{{ route('manager.maintenances.index') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group">
                    <div class="w-8 h-8 flex items-center justify-center rounded-lg bg-white/10 group-hover:bg-purple-500/30 transition-all">
                ...
                <a href="{{ route('manager.recettes.index') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group">
                    <div class="w-8 h-8 flex items-center justify-center rounded-lg bg-white/10 group-hover:bg-purple-500/30 transition-all">
                ...
                <a href="{{ route('manager.documents.index') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group">
                    <div class="w-8 h-8 flex items-center justify-center rounded-lg bg-white/10 group-hover:bg-purple-500/30 transition-all">
                ...
                <a href="{{ route('manager.rapports.index') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group">
                    <div class="w-8 h-8 flex items-center justify-center rounded-lg bg-white/10 group-hover:bg-purple-500/30 transition-all">
                ...
                <a href="{{ route('manager.audits.index') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group">
                    <div class="w-8 h-8 flex items-center justify-center rounded-lg bg-white/10 group-hover:bg-purple-500/30 transition-all">
                ...
                <a href="{{ route('manager.users.index') }}" class="nav-item flex items-center space-x-3 px-4 py-3 text-white/90 hover:text-white group">
                    <div class="w-8 h-8 flex items-center justify-center rounded-lg bg-white/10 group-hover:bg-purple-500/30 transition-all">
        ...
        <header class="bg-white dark:bg-gray-800 shadow-sm sticky top-0 z-10 border-b border-gray-100 dark:border-gray-700">
            <div class="px-4 sm:px-6 py-3 flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    <button @click="sidebarOpen = !sidebarOpen" class="lg:hidden text-gray-500 dark:text-gray-400 hover:text-purple-600 transition p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl">
