...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>TRANS BONY - Administration</title>
...
<body x-data="app()" :class="{'dark': isDarkMode}" class="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white transition-colors duration-300">
    <script>
        // On cache le preloader dès que le DOM est prêt
                ...
                <div class="flex items-center justify-between mb-8">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-blue-300 dark:text-gray-400 mt-1">Espace Admin</p>
                        </div>
                    </div>
                ...
                <div class="px-4 sm:px-6 py-3 flex justify-between items-center">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5 hidden sm:block">Administration • {{ auth()->user()->name }}</p>
                        </div>
                    </div>
