...
<div class="module-index-wrapper custom-scrollbar">
    ...
    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-amber-600 via-orange-600 to-red-700 p-6 animate-slide-down shadow-xl">
        ...
        <div class="relative flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-amber-100 text-sm mt-1">Consultation technique de la flotte</p>
                </div>
            </div>
            @can('gerer vehicules')
            <a href="{{ route($rolePrefix . '.vehicules.create') }}"
               class="group relative overflow-hidden px-6 py-3 bg-white text-orange-600 rounded-xl shadow-lg hover:bg-orange-50 transition-all duration-300 hover:scale-105">
