        ...
        <div class="relative flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-amber-100 text-sm mt-1">Interventions techniques et entretiens</p>
                </div>
            </div>
            ...
            <table class="w-full text-left border-collapse whitespace-nowrap">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700 text-sm">
                    ...
                    <tr class="hover:bg-amber-50/30 dark:hover:bg-amber-900/10 transition-colors">
                        <td class="p-4">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center"><i class="fas fa-bus text-xs"></i></div>
                        ...
                        <td class="p-4">
                            <span class="text-gray-700 dark:text-gray-300">{{ $m->date_prevue->format('d/m/Y') }}</span>
                        </td>
                        <td class="p-4">
                        ...
                        <td class="p-4 text-right">
                            <a href="{{ route('manager.maintenances.show', $m) }}" class="inline-flex items-center justify-center w-9 h-9 rounded-xl bg-gray-50 hover:bg-amber-100 text-gray-400 hover:text-amber-600 transition-all duration-300">
                                <i class="fas fa-eye"></i>
                            </a>
                        </td>
                    </tr>
                    @empty
                    <tr><td colspan="6" class="p-12 text-center text-gray-400">Aucune maintenance enregistrée.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
