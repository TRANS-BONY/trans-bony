...
<div class="module-index-wrapper custom-scrollbar">
    ...
    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-indigo-800 p-6 animate-slide-down shadow-xl">
        ...
        <div class="relative flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-indigo-100 text-sm mt-1">Consultez et gérez la flotte automobile</p>
                </div>
            </div>
        </div>
    </div>
