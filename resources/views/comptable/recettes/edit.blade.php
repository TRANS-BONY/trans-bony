...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden border border-gray-100 dark:border-gray-700 animate-fade-in-up">
        <form method="POST" action="{{ route('comptable.recettes.update', $recette) }}" class="p-8 space-y-6">
            @csrf @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <select name="voyage_id" id="voyage_select" required
                        ...
                        @foreach($voyages as $voyage)
                            <option value="{{ $voyage->id }}" 
                                    ...
                                    {{ old('voyage_id', $recette->voyage_id) == $voyage->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select name="vehicule_id" id="vehicule_select" required
                            class="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-600 text-gray-500 dark:text-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition cursor-not-allowed">
