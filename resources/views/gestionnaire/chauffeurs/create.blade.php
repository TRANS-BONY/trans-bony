...
<div class="space-y-6">
    ...
    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-emerald-600 via-teal-600 to-green-600 p-6 animate-slide-down shadow-xl">
        ...
        <div class="relative flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <a href="{{ route('gestionnaire.chauffeurs.index') }}"
    ...
    <div class="animate-fade-in-up" style="animation-delay: 0.1s">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-transparent dark:border-gray-700">
            ...
            <form method="POST" action="{{ route('gestionnaire.chauffeurs.store') }}" enctype="multipart/form-data" class="p-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="permis" value="{{ old('permis') }}" placeholder="Ex: CG-123456-ABC-2024"
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="contact" value="{{ old('contact') }}" placeholder="Nom et numéro du contact"
